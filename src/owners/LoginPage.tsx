...
const LoginPage: React.FC = () => {
    ...
    const handleLogin = () => {
        ...
        setTimeout(() => {
            ...
            if (formData.email === 'admin@turfkhana.com' && formData.password === 'admin123') {
                toaster.success({
                    ...
                    >
                        <VStack gap={6} align="stretch">
                            ...
                            <Field.Root required invalid={!!errors.email}>
                                ...
                                <InputGroup startElement={<Mail pointerEvents="none" size={20} />}>
                                    <Input
                                        type="email"
                            ...
                            <Field.Root required invalid={!!errors.password}>
                                ...
                                <InputGroup startElement={<Lock pointerEvents="none" size={20} />} endElement={<IconButton
                            ...
                            <Box
                                ...
                                fontSize="sm"
                            >
                                <Text fontWeight="semibold" mb={2} color={useColorModeValue('blue.700', 'blue.200')}>
                                    Demo Credentials:
                                </Text>
                                <VStack align="stretch" gap={1} fontSize="xs" color={useColorModeValue('blue.600', 'blue.300')}>
